...
>>>>>>> 0019cfa509b5f9577f49bf6b865d1d4d12dca4e2:Train.java
	...
	public void run() {
		SensorEvent e;
		// initialize
		this.goingDown = this.id == 1 ? true : false;
		...
		try {
			...
			// Train 1 that starts at the upper station needs to cross the crossroads before going in to the main loop.
			// Train 2 can proceed as usual.
			if (this.state == 0) {
				crossRoads();
			}
